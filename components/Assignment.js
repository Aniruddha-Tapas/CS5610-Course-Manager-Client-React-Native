...
class Assignment extends React.Component {
    ...
    createAssignment(){
        return fetch("http://localhost:8080/api/topic/"+this.state.topicId+"/assignment",{
                    ...
                    <View style={{flexDirection: 'row'}}>
                        ...
                        <Button title="Submit"
                                ...
                                onPress={() => {
                                    ...
                                    this.props.navigation.navigate("ShowAssignment", {topicId: this.state.topicId});}}/> :
                            <Button title="Update"
                        ...
                        {this.state.editable ?
                            <Button title="Delete"
                                    ...
                                    onPress={() => {
                                        this.deleteQuestion();
                                        this.props.navigation.navigate("ShowAssignment", {topicId: this.state.topicId});}}/> : null}
                    </View>
